...
public class GlavniProzor {
	...
	private static JTextPane queryTB = new JTextPane();
	...
	JTree tree;
	DefaultMutableTreeNode korijen;
	...
	private void initialize() {
		...
		queryTB.getDocument().addDocumentListener(new DocumentListener() {
			...
			public void warn() {
				...
				StyledDocument sdoc = queryTB.getStyledDocument();
		...
		chckbxLogirajUBazu.setBounds(853, 36, 95, 23);
		...
		panel_1.setBounds(231, 103, 480, 170);
		panel.add(panel_1);
		...
		separator.setBounds(231, 284, 717, 2);
		panel.add(separator);

		JPanel panel_2 = new JPanel();
		panel_2.setBorder(new EmptyBorder(0, 0, 0, 0));
		panel_2.setBounds(231, 485, 717, 33);
		panel.add(panel_2);
		...
		scrollPane_Log.setLocation(717, 121);
		...
		lblRecentlyExecutedQuerys.setBounds(717, 103, 227, 14);
		...
		separator_2.setBounds(14, 66, 934, 2);
		...
		separator_1.setBounds(14, 27, 934, 2);
		panel.add(separator_1);

		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(14, 103, 212, 415);
